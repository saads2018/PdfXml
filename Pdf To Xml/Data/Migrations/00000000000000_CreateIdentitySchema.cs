...
namespace Pdf_To_Xml.Data.Migrations
{
    public partial class CreateIdentitySchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtraUser", x => x.UserName);
                });
            ...
            migrationBuilder.CreateTable(
               ...
               columns: table => new
               {
                   ...
                   Xml = table.Column<byte[]>(type: "varbinary(MAX)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PdfTable", x => new { x.Id });
                }
              );
